...
def welcome():
    ...
    return (
        "Hawaii Climate Data<br/><br/>"
        "Choose from the available routes below:<br/><br/>"
        "Precipiation from 2016-08-23 to 2017-08-23.<br/>"
        "/api/v1.0/precipitation<br/><br/>"
        "A list of all the stations in Hawaii.<br/>"
        "/api/v1.0/stations<br/><br/>"
        "The Temperature Observations (tobs) from 2016-08-23 to 2017-08-23.<br/>"
        "/api/v1.0/tobs<br/><br/>"
        "Type in a single date (i.e., 2017-01-01) to see the min, max and avg temperature since that date.<br/>"
        "/api/v1.0/temp/<start><br/><br/>"
        "Type in a date range (i.e., 2017-01-01/2017-01-07) to see the min, max and avg temperature for that range.<br/>"
...
def precipitation():
    ...
    # Create a dictionary from the data & append to a list of for the precipitation data
    precipitation_data = []
...
def stations():
    ...
    # Create a dictionary from the data & ppend to a list of all_stations.
    all_stations = []
...
def tobs():
    ...
    # Create a dictionary from the data & append to a list of for the temperature data.
    temp_data = []
